...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO addProduct(ProductDTO productDTO, Long categoryId) {
        ...
        if (isProductNotPresent) {
            ...
            double specialPrice = product.getPrice() - (product.getDiscount() * product.getPrice() * 0.01);
    ...
    public ProductResponse searchByCategory(Long categoryId, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        ProductResponse productResponse = getProductResponse(productPage);
    ...
    public ProductDTO updateProduct(Long productId, ProductDTO productDTO) {
        ...
        double specialPrice = productFromDb.getPrice() - (productFromDb.getPrice() * productFromDb.getDiscount() * 0.01);
